...
function ToastPlayground() {
  ...
  return (
    <section className="section">
      <h2>Toast — triggers</h2>
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
        <Button palette="neutral" variant="subtle" onClick={() => toast.show('Generic toast')}>
          Show
        </Button>
        <Button palette="primary" variant="subtle" onClick={() => toast.info('Info: server connected')}>
          Info
        </Button>
        <Button palette="neutral" variant="subtle" onClick={() => toast.success('Changes saved')}>
          Success
        </Button>
        <Button palette="neutral" variant="subtle" onClick={() => toast.warning('Low disk space')}>
          Warning
        </Button>
        <Button palette="danger" variant="subtle" onClick={() => toast.error('Upload failed', { duration: 0 })}>
          Error (no auto-dismiss)
        </Button>
        <Button
          palette="neutral"
          variant="subtle"
          onClick={() => toast.show('Item deleted', {
        ...
        <Button
          ...
          onClick={() => {
            ...
            toast.info('Second')
            toast.info('Third')
            toast.info('Fourth — should evict First')
          }}
        >
          Test max=3 eviction
        </Button>
        <Button palette="neutral" variant="subtle" onClick={() => toast.dismiss()}>
          Dismiss all
        </Button>
      </div>
    </section>
